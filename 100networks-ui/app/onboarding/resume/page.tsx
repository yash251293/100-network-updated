...
// Dummy Client Component wrapper
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md text-center">
      ...
      <div className="border-2 border-dashed border-brand-border rounded-lg p-10 sm:p-16 mb-6">
        ...
        <Button className="bg-brand-blue hover:bg-brand-blue-light text-white font-medium">Upload Resume</Button>
      </div>
      ...
      <Button
        ...
        asChild
      >
        <Link href="/onboarding/done">Skip for now</Link>
      </Button>
    </div>
  )
}
