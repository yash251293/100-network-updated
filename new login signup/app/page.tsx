      ...
      <header className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="flex justify-between items-center">
          ...
          <div className="space-x-4 flex items-center">
            <Link href="#" className="text-sm font-bold text-brand-text-dark hover:text-brand-blue">
              Find Talent
            </Link>
            <Link href="#" className="text-sm font-bold text-brand-text-dark hover:text-brand-blue">
              Recruitment Opportunities
            </Link>
            <Button asChild className="ml-2 bg-brand-blue hover:bg-brand-blue-light px-5 py-2.5 text-sm font-medium">
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button size="lg" className="bg-brand-blue hover:bg-brand-blue-light text-base font-medium px-6 py-3">
                Sign In
              </Button>
            </div>
            <div>
              <Image
                src="/image2.png?width=600&height=500"
