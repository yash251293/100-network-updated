  ...
  <button
    ...
    className={cn(
      ...
      selectedValue === value
        ...
        : "bg-white text-brand-text-medium border-brand-border hover:border-brand-blue hover:text-brand-blue hover:shadow-sm",
      className,
    )}
  >
    {children}
        ...
        <form className="space-y-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2 mb-4">
              <BriefcaseIcon className="h-5 w-5 text-brand-blue" />
              ...
              {[
                ...
                <button
                  ...
                  className={cn(
                    ...
                    jobSearchStatus === item.value
                      ? "border-brand-blue ring-2 ring-brand-blue/20 bg-blue-50 shadow-md"
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    {jobSearchStatus === item.value && (
                      <CheckIcon className="w-5 h-5 text-brand-blue flex-shrink-0 mt-0.5" />
                    )}
                  </div>
                </button>
              ))}
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2 mb-2">
              <DollarSignIcon className="h-5 w-5 text-brand-blue" />
            ...
            <div className="flex items-center space-x-3">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="bg-brand-bg-input border-brand-border pl-9 focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/20"
                />
              </div>
              <Select defaultValue="usd">
                <SelectTrigger className="w-48 bg-brand-bg-input border-brand-border focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/20">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {roles.map((role) => (
                <span
                  key={role}
                  className="inline-flex items-center bg-brand-blue text-white text-sm font-medium px-4 py-2 rounded-full"
                >
                  {role}
                  <button
                    type="button"
                    onClick={() => setRoles((r) => r.filter((item) => item !== role))}
                    className="ml-2 text-white hover:bg-brand-blue-light rounded-full p-0.5 transition-colors"
                  >
            ...
            <Select onValueChange={(newRole) => !roles.includes(newRole) && setRoles((r) => [...r, newRole])}>
              <SelectTrigger className="w-full bg-brand-bg-input border-brand-border focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/20">
          ...
          <div className="pt-6">
            <Button
              type="submit"
              className="w-full bg-brand-blue hover:bg-brand-blue-light text-white py-3 font-medium text-base rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
              asChild
            >
