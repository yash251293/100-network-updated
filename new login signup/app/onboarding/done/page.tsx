      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-xl border border-blue-200 mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-brand-blue">35%</span>
          </div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
            <div className="h-3 bg-gradient-to-r from-brand-blue to-green-500 rounded-full transition-all duration-700 ease-out w-[35%]" />
          </div>
        </div>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-brand-text-dark mb-6 flex items-center">
            <SparklesIcon className="w-5 h-5 text-brand-blue mr-2" />
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-brand-blue to-brand-blue-light p-6 rounded-xl text-white text-center mb-6">
          ...
          <Button
            className="w-full bg-brand-blue hover:bg-brand-blue-light text-white py-4 text-lg font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
            asChild
          >
