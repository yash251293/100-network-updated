    ...
    <div className="min-h-screen bg-brand-bg-light-gray py-8">
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <form className="space-y-10">
          ...
          <div className="space-y-5">
            ...
            {location && (
              <div className="animate-in slide-in-from-left duration-300">
                <div className="inline-flex items-center bg-gradient-to-r from-brand-blue to-brand-blue-light text-white text-sm font-medium px-4 py-2.5 rounded-full shadow-md">
            ...
            <div className="relative">
              <Input
                ...
                className="bg-brand-bg-input border-brand-border placeholder-brand-text-light focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/20 pl-10"
              />
          ...
          <div className="border-t border-brand-border pt-8 space-y-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <Select>
                  <SelectTrigger className="w-full bg-brand-bg-input border-brand-border focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/20 h-12">
          ...
          <div className="border-t border-brand-border pt-8 space-y-6">
            <div className="flex items-center space-x-2 mb-6">
              <GraduationCapIcon className="h-5 w-5 text-brand-blue" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-brand-bg-input border-brand-border focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/20 h-12"
                  />
                </div>
                <div>
