              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-start space-x-2">
                      <img
                        src="/placeholder.svg?height=40&width=40&query=ra labs logo"
                        alt="Ra Labs"
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-start space-x-2">
                      <img
                        src="/placeholder.svg?height=40&width=40&query=instalify logo"
                        alt="Instalify, Inc."
                        className="h-10 w-10 rounded"
                      />
                      <div>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-start space-x-2">
                      <img
                        src="/placeholder.svg?height=40&width=40&query=dynex capital logo"
                        alt="Dynex Capital"
                        className="h-10 w-10 rounded"
                      />
                      <div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-start space-x-2">
                  <img
                    src="/placeholder.svg?height=40&width=40&query=google logo"
                    alt="Google"
                    className="h-10 w-10 rounded"
                  />
                  <div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-start space-x-2">
                  <img
                    src="/placeholder.svg?height=40&width=40&query=tech conference logo"
                    alt="TechConnect"
                    className="h-10 w-10 rounded"
                  />
                  <div>
