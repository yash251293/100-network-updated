...
export default function CompleteProfilePage() {
  ...
  return (
    <div style={{ border: "3px solid red", padding: "20px", margin: "20px", minHeight: "300px" }}>
      <h1>Complete Profile Page - Minimal Structure Test</h1>
      <p>This is testing if the page's own complex structure was causing pointer/scroll issues with the Sidebar.</p>
      <p>Please test clicking Sidebar links and page scrolling.</p>
    </div>
  );
}
